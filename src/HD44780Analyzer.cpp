...
void HD44780Analyzer::AdvanceToAbsPositionWhileMarking( AnalyzerChannelData* AACD, Channel AC, U64 APosition )
{
    ...
    while( mSettings->mMarkTimingErrors && AACD->WouldAdvancingToAbsPositionCauseTransition( APosition ) &&
           AACD->GetSampleOfNextEdge() < APosition )
    {
...
U32 HD44780Analyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate,
