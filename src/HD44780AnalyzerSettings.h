...
class HD44780AnalyzerSettings : public AnalyzerSettings
{
  public:
    ...
    U32 mEnableCycleMin, mEnablePulseWidthMin, mAddressSetupMin, mAddressHoldMin, mDataWriteSetupMin, mDataWriteHoldMin, mDataReadDelayMax,
        mDataReadHoldMin, mBusyTimeClearHome, mBusyTimeCmdChar;

    void ClearAndAddChannels();

  protected:
    std::auto_ptr<AnalyzerSettingInterfaceChannel> mEChannelInterface, mRSChannelInterface, mRWChannelInterface, mDBChannelInterface[ 8 ];
    ...
    std::auto_ptr<AnalyzerSettingInterfaceInteger> mEnableCycleMinInterface, mEnablePulseWidthMinInterface, mAddressSetupMinInterface,
        mAddressHoldMinInterface, mDataWriteSetupMinInterface, mDataWriteHoldMinInterface, mDataReadDelayMaxInterface,
        mDataReadHoldMinInterface, mBusyTimeClearHomeInterface, mBusyTimeCmdCharInterface;
};
