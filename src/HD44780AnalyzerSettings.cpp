      ...
      mDoNotGenerateBusyCheckFrames( false )
{
    ...
    mEnablePulseWidthMinInterface->SetTitleAndTooltip( "Enable Pulse Width Min (ns)",
                                                       "Enable pulse width minimum in ns, PWeh in datasheet." );
    ...
    mBusyTimeClearHomeInterface->SetTitleAndTooltip( "Busy Time for Clear/Home (us)",
                                                     "Busy time for clear display and return home in us." );
    ...
    mBusyTimeCmdCharInterface->SetTitleAndTooltip( "Busy Time for Command/Data (us)",
                                                   "Busy time for command and data reading or writing in us." );
